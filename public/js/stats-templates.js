...
<div class="stats-card">\
	<img class="champion-image" src="//ddragon.leagueoflegends.com/cdn/7.8.1/img/champion/{{imageName}}">\
...
var tableRowSource = '\
<td><img src="//ddragon.leagueoflegends.com/cdn/7.8.1/img/champion/{{imageName}}"></td>\
<td>{{championName}}</td>\
<td>{{games}}</td>\
